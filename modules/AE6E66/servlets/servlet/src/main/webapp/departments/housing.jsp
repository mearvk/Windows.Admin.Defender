...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/ministry-of-housing-communities-and-local-government";
    String deptName = "Ministry of Housing, Communities & Local Government";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Housing policy, planning permission, local government, building safety, and homelessness support.</p>
</div></section>
