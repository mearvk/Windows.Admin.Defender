...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/ministry-of-justice";
    String deptName = "Ministry of Justice";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Courts, tribunals, prisons, probation, legal aid, and constitutional reform.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Courts & Tribunals">Courts & Tribunals</option>
                    <option value="Prison Service">Prison Service</option>
                    <option value="Probation">Probation</option>
                    <option value="Legal Aid">Legal Aid</option>
                    <option value="Constitutional Reform">Constitutional Reform</option>
                    <option value="Victims Services">Victims Services</option>
