...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/department-for-environment-food-rural-affairs";
    String deptName = "Department for Environment, Food & Rural Affairs";
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Food Standards">Food Standards</option>
                    <option value="Rural Affairs">Rural Affairs</option>
