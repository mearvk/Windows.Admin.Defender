...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/department-for-culture-media-and-sport";
    String deptName = "Department for Culture, Media & Sport";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Arts, media, broadcasting, sport, gambling, tourism, and digital economy.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Gambling Regulation">Gambling Regulation</option>
