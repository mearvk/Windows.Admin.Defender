...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/hm-treasury";
    String deptName = "HM Treasury";
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Public Spending">Public Spending</option>
                    <option value="Financial Services">Financial Services</option>
                    <option value="Budget Inquiry">Budget Inquiry</option>
                    <option value="Fiscal Events">Fiscal Events</option>
