...
<%
    ...
    String targetHost = "www.parliament.uk";
    String targetUrl = "https://www.parliament.uk/site-information/contact-us/";
    String deptName = "UK Parliament";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Houses of Parliament — House of Commons and House of Lords. Legislative inquiries and public engagement.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="House of Lords">House of Lords</option>
                    <option value="Legislation">Legislation</option>
                    <option value="Select Committees">Select Committees</option>
                    <option value="Public Petitions">Public Petitions</option>
                    <option value="Parliamentary Tours">Parliamentary Tours</option>
