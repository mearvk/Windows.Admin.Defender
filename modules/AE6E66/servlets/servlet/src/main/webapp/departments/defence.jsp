...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/ministry-of-defence";
    String deptName = "Ministry of Defence";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>UK armed forces, defence policy, veterans support, military operations, and procurement.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Defence Policy">Defence Policy</option>
                    <option value="Armed Forces Careers">Armed Forces Careers</option>
                    <option value="Veterans Support">Veterans Support</option>
                    <option value="Military Operations">Military Operations</option>
