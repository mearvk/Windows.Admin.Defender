...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/department-for-energy-security-and-net-zero";
    String deptName = "Department for Energy Security & Net Zero";
