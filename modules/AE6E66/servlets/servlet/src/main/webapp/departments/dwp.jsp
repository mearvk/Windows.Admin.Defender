...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/department-for-work-pensions";
    String deptName = "Department for Work and Pensions";
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Jobseeker Support">Jobseeker Support</option>
                    <option value="Child Maintenance">Child Maintenance</option>
                    <option value="Carers Allowance">Carers Allowance</option>
