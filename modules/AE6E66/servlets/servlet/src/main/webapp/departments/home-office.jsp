...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/home-office";
    String deptName = "Home Office";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Immigration, passports, policing, counter-terrorism, drugs policy, and border control.</p>
</div></section>
