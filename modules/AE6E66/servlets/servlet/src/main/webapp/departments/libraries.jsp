...
<%
    ...
    String targetHost = "www.bl.uk";
    String targetUrl = "https://www.bl.uk/help/contact-us";
    String deptName = "British Library";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>British Library — the UK national library. Reading rooms, research services, document supply, and digital resources.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Reading Room Access">Reading Room Access</option>
                    <option value="Research Inquiry">Research Inquiry</option>
                    <option value="Document Supply">Document Supply</option>
