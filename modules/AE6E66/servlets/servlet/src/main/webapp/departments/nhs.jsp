...
<%
    ...
    String targetHost = "www.nhs.uk";
    String targetUrl = "https://www.nhs.uk/contact-us/";
    String deptName = "NHS — National Health Service";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>UK National Health Service — health inquiries, patient feedback, GP services, prescriptions, and emergency information.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="GP Registration">GP Registration</option>
