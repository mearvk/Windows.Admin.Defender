...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/foreign-commonwealth-development-office";
    String deptName = "Foreign, Commonwealth & Development Office";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Foreign affairs, diplomacy, international development, consular services, and overseas trade.</p>
</div></section>
...
<section class="section"><div class="section-inner" style="max-width:750px;">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group"><label>Category</label><select name="message_category" required>
                    ...
                    <option value="Consular Assistance">Consular Assistance</option>
                    ...
                    <option value="Travel Advisory">Travel Advisory</option>
