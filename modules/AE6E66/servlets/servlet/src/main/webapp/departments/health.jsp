...
<%
    ...
    String targetUrl = "https://www.gov.uk/government/organisations/department-of-health-and-social-care";
    String deptName = "Department of Health and Social Care";
...
<section class="hero" style="padding:4rem 2rem;"><div class="hero-inner">
    ...
    <h1><%= esc(deptName) %></h1>
    <p>Health policy, social care reform, public health strategy, and workforce planning for England.</p>
</div></section>
