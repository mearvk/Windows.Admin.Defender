...
Central list for Windows 10 release, architecture, driver, security, administration, compatibility, and support information.

## Protected folders and files baseline

The Windows 10 protected-system baseline incorporates the folder/file series defined in `sacred-files.json`. The descriptions below explain what each location does and why it matters to system integrity, application operation, recovery, or user data.
...
Paths are documented as representative Windows locations. Actual layout can vary by architecture, installation configuration, release, and recovery configuration.
